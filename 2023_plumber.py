...
with pdfplumber.open(pdf_file) as pdf:
    ...
    for i, pg in enumerate(pdf.pages):
        try:
            ...
            resident_data = arr[:, 0:17]
            non_resident_data = arr[:, 17:]
            ...
            resident_odds = get_success_ratio(resident_data[-1, -2])
            non_resident_odds = get_success_ratio(non_resident_data[-1, -3])
